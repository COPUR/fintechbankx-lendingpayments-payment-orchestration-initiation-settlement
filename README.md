...
Bu repository, FinTechBankX DDD/EDA dönüşümünde **svc-pay-initiation-settlement** servis yetkinliğinin kaynak kodunu, kontratlarını ve operasyonel guardrail'lerini içerir.
...
| Squad | Payment Orchestration Squad |
| Repo Kümesi (Capability) | payments |
| Service ID | svc-pay-initiation-settlement |
| Bounded Context | payment_initiation_settlement |
| Wave | 3 |
...
## Kapsam
### In Scope
- payment_initiation_settlement bağlamına ait uygulama kodu, testler ve otomasyon.
