...
- **Repo Kümesi:** `payments-core`
- **Bounded Context:** `payments`
- **Ana Capability:** Payment initiation and settlement orchestration
- **Dönüşüm Wave:** 3
...
- `Payment initiation and settlement orchestration` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
